...
exports.loginAutoFn = exports.loginFn = exports.signupFn = void 0;
...
function signupFn(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, newPassword, newUser, payload, token, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    token = jsonwebtoken_1.default.sign(payload, process.env.JWTSECRET);
                    res.status(201).json({
                        status: 'sucess',
                        token: token,
                        data: newUser,
...
function loginAutoFn(req, res) {
    return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/];
    }); });
}
exports.loginAutoFn = loginAutoFn;
